        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="space-y-3 stagger-4 opacity-0 animate-slide-up" data-tour="quick-actions">
            ...
            <div className="grid grid-cols-3 gap-3">
              <Link to="/bills/new">
                <Button variant="ghost" className="w-full h-auto py-4 flex-col gap-2 rounded-xl border border-border bg-card hover:bg-accent/50 transition-colors">
                  <div className="h-10 w-10 rounded-xl bg-primary/10 flex items-center justify-center">
                    <Receipt className="h-5 w-5 text-primary" />
                  </div>
                  <span className="text-xs font-semibold text-foreground">Split Bill</span>
              ...
              <Link to="/ious/new">
                <Button variant="ghost" className="w-full h-auto py-4 flex-col gap-2 rounded-xl border border-border bg-card hover:bg-accent/50 transition-colors">
                  ...
                  <span className="text-xs font-semibold text-foreground">Track Owe</span>
